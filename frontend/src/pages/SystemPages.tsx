  ...
  return (
    <main className="grid min-h-[70vh] place-items-center p-6 text-center">
      <div>
        ...
        <p className="mt-5 font-mono text-xs tracking-[.2em] text-kandor-400">
          {code}
        </p>
...
export function UnauthorizedPage() {
  return (
    <SystemPage
      ...
      description="Your current KANDOR role does not permit access to this control surface. This attempt has not changed any system state."
    />
  );
}
    ...
    <main className="grid min-h-screen place-items-center bg-void p-6 text-center">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-500">
          The requested KANDOR route does not exist.
        </p>
        <Link to="/dashboard">
